...
const Features = () => {
  const features = [
    {
      icon: <LockIcon className="h-10 w-10 text-blockloan-blue" />,
  ...
  return (
    <div className="bg-blockloan-light py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-blockloan-blue mb-4">Why Choose BlockLoan?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="card-hover border-t-4 border-t-blockloan-teal">
